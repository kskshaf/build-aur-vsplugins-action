...
git clone --recursive https://github.com/HomeOfAviSynthPlusEvolution/neo_FFT3D.git
cd neo_FFT3D
...
cd x264
./configure --prefix=$OWN_PREFIX --extra-cflags="$NATIVE -I$MYICPH -mno-avx512f" --disable-interlaced --disable-opencl --enable-lto --enable-strip --disable-avs --disable-swscale --disable-lavf --disable-ffms --disable-avi-output --disable-gpac --disable-lsmash --disable-audio --disable-qtaac --disable-faac --disable-mp3 --disable-lavc
make -j$(nproc)
